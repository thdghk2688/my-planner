  ...
  return (
    <div onClick={()=>selMode?onSel(t.id):onClick(t)}
      ...
      <div style={{display:"flex",gap:4,marginTop:1,paddingLeft:10,flexWrap:"wrap"}}>
        ...
        <span style={{fontSize:7,padding:"0 2px",borderRadius:2,lineHeight:"4px",height:"4px",background:PC[t.priority]+"22",color:PC[t.priority],display:"inline-block"}}>{PL[t.priority]}</span>
